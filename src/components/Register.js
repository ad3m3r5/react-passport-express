...
class Register extends Component {
    ...
    handleSubmit = (e) => {
        e.preventDefault();
        let { username, password, passconf } = this.state;
        this.setState({ message: null, error: null, password: '', passconf: '' }, () => {
            axios.post('/register', {username: username, password: password, passconf: passconf})
            .then(response => {
                ...
                <div className={classes.content}>
                    ...
                    <Zoom in={true} timeout={600}>
                        <Typography variant="h3" className={classes.register}>
                            <PersonAdd style={{ fontSize: '3rem', verticalAlign: 'middle' }} /> Register
                        </Typography>
                    </Zoom>
                    <form
